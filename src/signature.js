...
export function generateSignatureHTML() {
  ...
  return [
    '<br>',
    '<div data-opg-signature="true" style="font-family:Arial,Helvetica,sans-serif;color:#222222;font-size:14px;line-height:1.6;">',
    '<div style="font-family:Arial,Helvetica,sans-serif;color:#222222;font-size:14px;line-height:1.6;margin:0 0 18px 0;">',
    '<span style="display:block;">--</span>',
    '<span style="display:block;margin-top:14px;">Best Regards,</span>',
    '</div>',
    '<table style="font-size:14px;font-family:Arial,Helvetica,sans-serif;line-height:1.4;" width="600">',
    '<tbody>',
    '<tr>',
    '<td>',
    '<table>',
    ...
    '<td style="padding:0px;"><span style="color:#000000;"><a href="https://outsourcedproglobal.applytojob.com/apply" style="color:#1155cc;font-size:14px;">OPG Careers Page</a></span></td>',
    '</tr>',
    '<tr>',
